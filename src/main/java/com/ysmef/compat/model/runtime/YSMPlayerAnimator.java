...
public final class YSMPlayerAnimator implements Molang.Env {
     ...
     *
     * <p>No cloth is solved here. This runs on the path that evaluates YSM's own scripts,
     * which is the outside-battle-mode path, where YSM's renderer draws the player and the
     * converted mesh is not on screen at all; the cloth is driven from the mesh's draw
     * call instead - see {@link YsmMeshCloth}.
     */
