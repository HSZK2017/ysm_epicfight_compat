...
// GPU skinning fragment shader for converted YSM-EF meshes.
// Ported from ModernYSM (OpenYSM) bone_skin.fsh: replicates Minecraft's entity
// shader semantics (cutout/translucent alpha modes, overlay texelFetch, lightmap
// texelFetch, linear fog) with the model texture on Sampler0, the overlay
// texture on Sampler1 and the lightmap on Sampler2.
