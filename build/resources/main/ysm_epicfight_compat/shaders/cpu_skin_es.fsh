...
// CPU skinning fragment shader for converted YSM-EF meshes - GLES 3.0 variant
// for Android launchers. Same math as the desktop cpu_skin.fsh and the GPU
// path's bone_skin_es.fsh (model texture on Sampler0, overlay texture on
// Sampler1, lightmap on Sampler2, replicating Minecraft's entity shader
// semantics), only the GLSL version differs.
