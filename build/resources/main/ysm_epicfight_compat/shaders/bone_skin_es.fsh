...
// GPU skinning fragment shader for converted YSM-EF meshes - GLES 3.1 variant
// for Android launchers. Same math as the desktop bone_skin.fsh (#version 430):
// model texture on Sampler0, overlay texture on Sampler1, lightmap on Sampler2,
// replicating Minecraft's entity shader semantics (cutout/translucent alpha
// modes, overlay texelFetch, lightmap texelFetch, linear fog).
